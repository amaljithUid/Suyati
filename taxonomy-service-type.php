...
<?php }?>
		    <h1><?php single_cat_title();?></span></h1>
	    		<?php echo get_field('banner_content',"service-type_".$term);?>
	    </div>
			    ...
			    <div class="splitted-container">
				    <div class="row">
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
							<div class="cms-wrapper">
                                                           ...
                                                           query_posts($query_string . "&order=ASC&order_by=menu_order");
                                                            $count_posts = wp_count_posts(); $t_cnt=0;
							    ...
							    elseif($cnt%3 == 2){ $block_color = "green";}
									...
									<div class="row">
										<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
											<div class="image-wrapper" class="img-responsive">
								...
								<div class="cms-row ektron">
									<div class="row">
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
											<div class="text-wrapper">
												<?php $num = get_field( "show_numbers", $p_id);if($num):?>
												<h6 class="special-num red">01</h6>
												<?php endif;?>
										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="img-wrapper">
												<?php if(get_field( "red_image", $p_id)!=""){?><img src="<?php echo get_field( "red_image", $p_id);?>"><?php }?>
											</div>
										</div>
									</div>
								...
								<div class="cms-row ektron">
									<div class="row">
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
											<div class="text-wrapper">
												<?php if($num):?>
												<h6 class="special-num green">02</h6>
												<?php endif;?>
										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="img-wrapper">
												<?php if(get_field( "green_image", $p_id)!=""){?><img src="<?php echo get_field( "green_image", $p_id);?>"><?php }?>	
											</div>
										</div>
									</div>
								...
								<div class="cms-row ektron">
									<div class="row">
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
											<div class="text-wrapper">
												<?php if($num):?>
												<h6 class="special-num blue">03</h6>
												<?php endif;?>
										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="img-wrapper">
												<?php if(get_field( "blue_image", $p_id)!=""){?><img src="<?php echo get_field( "blue_image", $p_id);?>"><?php }?>
											</div>
										</div>
									</div>
								...
								<div class="cms-row ektron">
									<div class="row">
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
											<div class="text-wrapper">
												<?php if($num):?>
												<h6 class="special-num orange">04</h6>
												<?php endif;?>
										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="img-wrapper">
												<?php if(get_field( "orange_image", $p_id)!=""){?><img src="<?php echo get_field( "orange_image", $p_id);?>"><?php }?>
											</div>
										</div>
									</div>
							...
							<?php if(get_field( "template", $p_id)=="simple"):?>
								...
								<div class="cms-row ektron ">
									<div class="row">
										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="img-wrapper">
												<?php if(get_field( "simp_image", $p_id)!=""){?><img src="<?php echo get_field( "simp_image", $p_id);?>"><?php }?>
											</div>
										</div>
									</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<?php if($t_cnt>1): get_sidebar('services'); else: get_sidebar('services-detail');endif;?>
