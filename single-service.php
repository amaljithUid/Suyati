...
<div class="breadcrumb-container">
	<div class="container">
		  ...
		  $techtype = get_the_terms( $post->ID, 'service-type' );
		  $tname = preg_replace('/\s+/', '-', $techtype[0]->name);
		  $tslug = strtolower($tname);
		  if($tslug != 'cms') {
		    $techtypeurl = $site_url.'/services-'.$tslug;
		  }
		  else {
		  	$techtypeurl = $site_url.'/service';
		  }
		  ?>
		  <div class="breadcrumb">
            ...
            <span class="seperator"></span>
            <span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" title="Go to Services." href="<?php echo $site_url;?>/service/">Services</a></span>
            <span class="seperator"></span>
