...
<html lang="en">
  <head>
    ...
    <?php
    /**
    * Template Name: CTI Development Integration - Texas
    Author:Suyati
    Theme Name:Suyati
    */
    wp_head();
...
<!-- End Google Tag Manager -->
      ...
      <div class="container">
          ...
          <div class="top-heading text-center">
           ...
           <!--  <img src="http://suyati.com/wp-content/uploads/2015/02/rwd-logo.png" alt="salesforce-logo2" width="474"  class="alignleft size-full wp-image-18662" /> -->
            CTI Development & Integration - Texas
            </h1>
    ...
    <div class="container">
      <div class="col-md-8 col-sm-12 col-xs-12">
        <p>
          Suyati offers Computer Telephony Integration (CTI) development for customers based out of Texas.
           Our capabilities range from out-of-the-box CTI solutions to pre-integrated solutions 
           with leading CRM tools that allow for fully customized CTI implementations for users in Texas. 
           We offer high-performance, scalable solutions for configuring 
        ...
        <p>
          Suyati’s unique specialization and niche capabilities offer 
          its customers world-class and cutting edge solutions in Open 
          CTI development and integration for major CRMs like Salesforce.
           We have deployed custom technology solutions for various customers
            in the US and particularly in Texas. Integrating your CTI system with 
            your CRM ensures that you make the best use of your customer data that is already available.
        ...
        <div class="row">
          <div class="points clearfix">
            ...
            <p>
              <h3>Our Texas-based CTI development capabilities include:</h3>
