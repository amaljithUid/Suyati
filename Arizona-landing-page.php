...
<html lang="en">
  <head>
    ...
    <?php
    /**
    * Template Name:CTI Development Integration - Arizona
    Author:Suyati
    Theme Name:Suyati
    */
    wp_head();
...
<!-- End Google Tag Manager -->
    ...
    <div class="landing-page-banner" style="background-image: url('http://suyati.com/wp-content/uploads/2015/02/CTI_BANNER.jpg');">
      <div class="container">
          ...
          <div class="top-heading text-center">
           ...
           CTI Development & Integration - Arizona
            </h1>
    ...
    <div class="container">
      <div class="col-md-8 col-sm-12 col-xs-12">
        <p>
          Suyati offers Computer Telephony Integration (CTI) development for customers based out 
          of Arizona. Our capabilities range from out-of-the-box CTI solutions to pre-integrated 
          solutions with leading CRM tools that allow for fully customized CTI implementations
           for users in Arizona. We offer high-performance, scalable solutions for configuring 
           and deploying CTI applications with third-party platforms including CRMs and workflow solutions.

        </p>
        <br>
      
        <p>
          Suyati’s unique specialization and niche capabilities offer its customers world-class
           and cutting edge solutions in Open CTI development and integration for major CRMs like
            Salesforce. We have deployed custom technology solutions for various customers in the
             US and particularly in Arizona. Integrating your CTI system with your CRM ensures that 
             you make the best use of your customer data that is already available.
           Following statistics show that CTI lays the foundation for a cost effective contact center:
        ...
        <div class="row">
          <div class="points clearfix">
            ...
            <p>
              <h3>Our Arizona-based CTI development capabilities include: </h3>
