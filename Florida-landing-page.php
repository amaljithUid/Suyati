...
<html lang="en">
  <head>
    ...
    <?php
    /**
    * Template Name: CTI Development Integration - Florida
    Author:Suyati
    Theme Name:Suyati
    */
    wp_head();
...
<!-- End Google Tag Manager -->
    ...
    <div class="landing-page-banner" style="background-image: url('http://suyati.com/wp-content/uploads/2015/02/CTI_BANNER.jpg');">
      <div class="container">
          ...
          <div class="top-heading text-center">
           ...
           CTI Development & Integration - Florida
            </h1>
    ...
    <div class="container">
      <div class="col-md-8 col-sm-12 col-xs-12">
        <p>
          Suyati offers Computer Telephony Integration (CTI) development for customers
           based out of Florida. Our capabilities range from out-of-the-box CTI 
           solutions to pre-integrated solutions with leading 
           CRM tools that allow for fully customized CTI implementations for users in Florida.
            We offer high-performance, scalable solutions for configuring and deploying 
          CTI applications with third-party platforms including CRMs and workflow solutions.
        ...
        Salesforce. We have deployed custom technology solutions for various customers in the US 
        and particularly in Florida. Integrating your CTI system with your CRM ensures that you 
        make the best use of your customer data that is already available.
        ...
        <div class="row">
          <div class="points clearfix">
            ...
            <p>
              <h3>Our Florida-based CTI development capabilities include:</h3>
