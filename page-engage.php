				    ...
				    <div class="row">
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
							<div class="cms-wrapper engage-page">
							    <?php   $args = array('posts_per_page'   => -1,'orderby'=>'menu_order','order'=>'ASC', 'post_type'=>'engagementmodels'); $domains = get_posts( $args ); $cnt = 0; foreach($domains as $domain):$cnt++;
							    if($cnt % 4 == 1){$color = "red";}elseif($cnt % 4 == 2){$color = "blue";}elseif($cnt % 4 == 3){$color = "green";}else{$color = "orange";}?>
